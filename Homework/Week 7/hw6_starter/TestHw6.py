...
class TestCocktailSort(unittest.TestCase): pass
   ...
   #    self.assertEqual(cocktail_sort(randomList), sorted(randomList))
...
#          randomList.append(x)
#          random.shuffle(randomList)
#       self.assertEqual(opt_insertion_sort(randomList), sorted(randomList))
